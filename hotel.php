...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav --> 
    <div class="hero-wrap js-fullheight" style="background-image: url('images/Kerala1.jpg');">
        ...
        <div class="container">
          ...
          <div class="col-lg-12">
          	<div class="row">
						  ...
						  <?php
									 $sql2= "SELECT * FROM packages where status=1";
		    				...
		    				<div class="destination">
		    			        <a class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/voyage/images/<?php echo $row2["image"]; ?> );">
		    					</a>
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
		    						...
		    						<p class="bottom-area d-flex">
		    							<span><i class="icon-map-o"></i>  <?php echo $row2["duration"]; ?> Days</span> 
		    							   <span class="ml-auto"><a href="booking.php?val=<?php echo $row2['package_ID']; ?>">Book Now</a></span>
		    						</p>
		    					</div>
		    				</div>
		    			</div>

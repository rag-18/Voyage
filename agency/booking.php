...
<html lang="en">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-dark" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">VOYAGE Agency</a>
...
<section>
 ...
 <table border="2" width="82%" height="20%" align="center">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM booking WHERE agency_ID = ?";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "</td>
                    <td><a href='confirm.php?id={$row['booking_ID']}'>Confirm</a> / <a href='cancel.php?id={$row['booking_ID']}'>Cancel</a></td>
                </tr>";
                $index++;
            }
        } else {

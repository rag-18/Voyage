...
<!-- End Logout Modal -->
		<br>
			...
			<section>
				<div class="col-lg-10" style="max-width: 93%; margin: auto;">
					<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
						<div class="heading-section ftco-animate">
							<h2 class="mb-3	">Packages</h2>
						</div>
						<div>
							<a href="add.php" class="btn" style="background-color: #343a40; color: white; width: 70px; border: none;">Add</a>
						</div>
					</div>
				</div>
			</section>
			    <table border="2" width="91%" height="50%" align="center">
				<tr>
				<th>#</th>
				<th>Package Name</th>	
				<th>Description</th>
			...
			<?php
			$sql = "SELECT * FROM packages WHERE agency_ID = '$agencyid'";
			...
			if ($result->num_rows > 0) {
				while ($row = $result->fetch_assoc()) {
					echo "<tr>
						...
						<td>{$row['price']}</td>
						<td>{$row['duration']}</td>
						<td><img src='/voyage/images/{$row['image']}' height='40' width'40' /></td>
						<td>{$row['pacType']}</td>
						<td>";
					...
					echo "</td>
						<td><a href=\"edit.php?val={$row['package_ID']}\"><img src=\"../../admin/img/edit.png\" height=\"20\" width=\"20\" /></a></td>
						<td><a href=\"delete.php?val={$row['package_ID']}\"><img src=\"../../admin/img/delete.png\" height=\"20\" width=\"20\" /></a></td>
					</tr>";
					$index++;
				}
			}

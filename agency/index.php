...
$email=$_SESSION['a'];
$stmt = $conn->prepare("SELECT agency_ID FROM agency WHERE email = ?");
...
$totalBookings = fetchCount($conn, "SELECT COUNT(*) AS total FROM booking WHERE agency_ID = '$agencyid'");
$pendingRequests = fetchCount($conn, "SELECT COUNT(*) AS total FROM booking WHERE status = '0' AND agency_ID = '$agencyid'");
...
<html lang="en">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-dark" id="ftco-navbar">
	    <div class="container">
	      <div class="navbar-brand">VOYAGE Agency</div>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="packages/index.php" class="nav-link">Packages</a></li>
			    <?php 
				if (isset($_SESSION['a'])): 
				$user=$_SESSION['a'];
				?>
...
<div class="admin-dashboard container">
        ...
        <div class="col-md-6">
            <div class="card text-white bg-success">
                <div class="card-body">
                    ...
                    <p class="card-text"><?php echo $pendingRequests; ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            ...
            <ul class="list-group">
                <?php
                $activities = $conn->query("SELECT * FROM booking WHERE agency_ID=$agencyid ORDER BY booking_ID DESC LIMIT 5");
                while ($activity = $activities->fetch_assoc()) {
                    echo "<li class='list-group-item'> #BK{$activity['booking_ID']} - {$activity['title']} - {$activity['todate']}- {$activity['fromdate']}</li>";
                }
                ?>
            </ul>
        </div>
